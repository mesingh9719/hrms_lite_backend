"""
Base settings for HRMS Lite project.
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'hrms_lite.pagination.StandardPagination',
    'PAGE_SIZE': 20,
    'EXCEPTION_HANDLER': 'hrms_lite.exceptions.custom_exception_handler',
